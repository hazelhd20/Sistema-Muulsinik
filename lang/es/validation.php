...
return [
    ...
    */
    ...
    | Esto permite especificar rápidamente un mensaje de lenguaje personalizado
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de lenguaje se utilizan para reemplazar el
    | marcador de posición del atributo con algo más legible, como
    ...
    */
    ...
    'attributes' => [
        ...
        'itemUnit'          => 'unidad',
        'itemPrice'         => 'precio',
        'reqProjectId'      => 'proyecto',
        'reqDescription'    => 'descripción',
        ...
        'docCategory'       => 'categoría del documento',

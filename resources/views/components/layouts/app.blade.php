    ...
    <div class="flex min-h-screen">
        ...
        <aside class="fixed inset-y-0 left-0 z-50 w-[15rem] bg-surface-sidebar flex flex-col
            ...
            <div class="flex items-center justify-center h-14 shrink-0 px-5">
                <img src="{{ asset('images/logo_muulsinik.svg') }}" alt="Muulsinik ERP" class="app-logo object-contain"
            ...
            <div class="px-3 py-3 space-y-0.5 shrink-0">
                ...
                <div class="flex items-center gap-2.5 px-2.5 py-2 mb-1"
                     x-data="{
                         ...
                         initial: @js(strtoupper(substr(auth()->user()->name ?? 'U', 0, 1)))
                     }"
                    ...
                    <template x-if="!avatarUrl">
                        <div class="w-7 h-7 rounded-full bg-primary-600 dark:bg-primary-500 text-white flex items-center justify-center shrink-0 select-none shadow-sm">
                            <span class="text-xs-fluid font-bold leading-none inline-flex items-center justify-center" x-text="initial"></span>
                        </div>
                    </template>
        ...
        <div class="flex-1 flex flex-col min-w-0">
            ...
            <header class="sticky top-0 z-35 bg-surface-main/90 backdrop-blur-md border-b border-border/40">
                <div class="flex items-center justify-between h-14 px-5 lg:px-6 max-w-screen-2xl mx-auto w-full">
                    ...
                    {{-- Right: Global Search + Notifications + Theme Toggle --}}

...
<div class="flex items-start gap-3">
    <label for="{{ $id }}" class="group relative flex items-center cursor-pointer mt-0.5">
        <input 
            type="checkbox"
            id="{{ $id }}"
            class="peer sr-only"
            {{ $attributes }}
        >
        <div class="h-5 w-9 rounded-full bg-border peer-checked:bg-primary-600 transition-colors duration-200 ease-in-out peer-focus-visible:ring-2 peer-focus-visible:ring-primary-500 peer-focus-visible:ring-offset-2"></div>

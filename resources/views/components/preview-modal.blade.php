<div x-data="{ 
    ...
    <div x-show="showPreviewModal"
         class="modal-overlay absolute inset-0 bg-black/40 backdrop-blur-[2px]"
    ...
    <div x-show="showPreviewModal"
         class="modal-panel w-full max-w-5xl h-[90vh] flex flex-col overflow-hidden bg-surface-card shadow-2xl rounded-xl border border-border relative"
         x-transition:enter="transition-premium"

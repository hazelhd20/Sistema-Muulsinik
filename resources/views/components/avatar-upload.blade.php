    ...
    <div class="flex-1 text-center sm:text-left space-y-1.5">
        ...
        <div class="flex flex-wrap items-center justify-center sm:justify-start gap-2 pt-1">
            ...
            <label for="{{ $inputId }}"
                ...
                class="inline-flex items-center justify-center gap-1.5 px-3 py-1.5 min-w-[6.5rem] rounded-md border border-border bg-surface text-text-primary hover:bg-surface-hover text-xs font-medium cursor-pointer transition-colors shadow-2xs">

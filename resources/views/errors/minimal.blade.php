...
<body class="antialiased min-h-screen bg-surface-main flex items-center justify-center p-4 sm:p-6 relative overflow-hidden font-sans">
    ...
    <div class="w-[90%] sm:w-full max-w-[340px] sm:max-w-md mx-auto text-center">
        ...
        <div class="bg-surface-card border border-border rounded-2xl p-6 sm:p-8 shadow-sm relative overflow-hidden transition-all duration-300">

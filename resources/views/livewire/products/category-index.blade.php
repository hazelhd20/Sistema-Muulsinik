<div>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
        <div>
            ...
            <h1 class="text-h1 text-text-primary">Categorías</h1>
        </div>
                ...
                @empty
                    <tr>
                        <td colspan="2" class="text-center py-12">
                            <i data-lucide="layers" class="w-8 h-8 mx-auto mb-2 text-text-muted opacity-25"></i>
                            <p class="text-small text-text-muted">No se encontraron categorías.</p>
                        </td>
                    </tr>
                @endforelse
            </tbody>

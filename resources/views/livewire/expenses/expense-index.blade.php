                                            ...
                                            <x-dropdown align="right" width="48">
                                                ...
                                                <x-slot name="content">
                                                    @if($expense->receipt_file)
                                                        <x-dropdown-link href="{{ \App\Support\StorageResolver::resolveUrl($expense->receipt_file) ?? route('file.preview', ['path' => $expense->receipt_file]) }}" target="_blank" icon="file-text">
                                                            Ver comprobante
                                                        </x-dropdown-link>
                                                    @endif
                                    ...
                                    <div class="flex items-center justify-between gap-2 p-4 pb-3 border-b border-border/40 bg-surface-card">
                                        ...
                                        <div class="flex items-center gap-2 shrink-0">
                                            ...
                                            <x-dropdown align="right" width="48">
                                                ...
                                                <x-slot name="content">
                                                    @if($expense->receipt_file)
                                                        <x-dropdown-link href="{{ \App\Support\StorageResolver::resolveUrl($expense->receipt_file) ?? route('file.preview', ['path' => $expense->receipt_file]) }}" target="_blank" icon="file-text">Ver comprobante</x-dropdown-link>
                                                    @endif
                                                    @if(auth()->user()?->hasPermission('gastos.eliminar') || auth()->user()?->hasPermission('*'))

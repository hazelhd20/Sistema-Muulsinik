        ...
        <x-modal show="showEditModal" title="Editar Proyecto">
                <form wire:submit="updateProject" class="p-5 space-y-4">
                    ...
                    <div class="flex justify-end gap-3 pt-4 border-t border-border">
                        ...
                        <button type="submit" class="btn-primary relative" wire:loading.attr="disabled" wire:target="updateProject">
                ...
                <form wire:submit="createProject" class="p-5 space-y-4">
                    ...
                    <div class="flex justify-end gap-3 pt-4 border-t border-border">
                        <button type="button" wire:click="$set('showCreateModal', false)"
                            class="btn-secondary">Cancelar</button>
                        <button type="submit" class="btn-primary relative" wire:loading.attr="disabled" wire:target="createProject">
